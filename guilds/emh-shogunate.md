...
**EMH-Shogunate** is missing lore and screenshots — if you're one of the builders, [join our Discord](https://discord.gg/Qygt9u26Bn) and post in `#base-guild-showcase` to:
...
```
## :japanese_castle: EMH-Shogunate [YOUR_GUILD_ID]
:construction_worker: Builders: ToxotesToons
