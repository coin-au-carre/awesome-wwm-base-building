...
**Aurore** is missing lore and screenshots — if you're one of the builders, [join our Discord](https://discord.gg/Qygt9u26Bn) and post in `#guild-case-showcase` to:
...
<pre>
## :japanese_castle: Aurore [guild_id]
