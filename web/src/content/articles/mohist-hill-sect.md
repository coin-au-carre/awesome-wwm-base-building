...
Building Thesis Score

- Maximum thesis score: 4,800
...
#### Small Ratchets (小棘轮) - used for Divinecraft upgrades.

Obtained from monkey enemies.

Best farming location:

Junzi Slope (君子坡)

Alternate between the two monkey camps.

Use drop-rate buffs.

You'll need approximately 6 Small Ratchets to unlock all Tiangong enhancements.
...
Check our farming guide on Discord. Solo builders are the best farmers.

Purchase also from the General Store.
...
A useful tip: purchasing wood and ore from vendors still contributes to Research Value, so don't feel obligated to gather everything manually.

## Tips, Troubleshooting & Weekly Routine

### Hard Labor System

If you leave Hidden Mountain in multiplayer, you are expected to disguise yourself. If discovered, guards arrest you and you perform "hard labor."

Ironically, hard labor is beneficial because it grants Research Value, and uses no materials from your inventory.

Can only happen once per day.

You can intentionally get caught once day for the free progress.

 

### Elder NPC Issues

If Elder He cannot be interacted with:

1. Your thesis may still be awaiting Week 2 approval.
2. Another player may have killed the Elder.

Re-enter the area or switch instances or restart the game if necessary.
...
1. Complete sect missions.
2. Farm monkeys for Small Ratchets.
3. Gather or buy wood, ore, and magnetite.
4. Create diagrams (9 repetitions for easy points).
5. Place construction objects.
6. Coordinate collaborative research.
7. Submit your thesis.
8. Apply for promotion during Week 2.
9. Get arrested once for free hard labor progress (optional)

### How to leave the sect

Like any other sect, you betray your master, get teleported to perception forest, after that you will lose all your sect benefits and become sectless.
