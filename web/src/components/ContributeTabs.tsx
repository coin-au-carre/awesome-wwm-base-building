            ...
            <Card>
              <CardContent className="divide-y divide-border p-0">
                {[
                  ...
                  {
                    icon: <Eye className="size-4 text-rose-400 shrink-0 mt-0.5" />,
                    title: "Spoiler text",
                    body: <>Wrap text in <code className="rounded bg-muted px-1 py-0.5 font-mono text-xs">||like this||</code> to hide it behind a spoiler. Readers click to reveal it on the website.</>,
                  },
                  {
